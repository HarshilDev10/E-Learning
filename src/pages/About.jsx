    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-white flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-2xl shadow-xl p-10 max-w-3xl w-full text-center">
        ...
        <p className="text-gray-700 text-lg leading-relaxed mb-8">
          Hello! I’m <span className="font-semibold text-black">Harshil Patel</span>, a passionate full-stack web
          developer. I love working with modern technologies like <span className="text-blue-500 font-medium">React</span>, 
          <span className="text-cyan-500 font-medium"> Tailwind CSS</span>, <span className="text-green-500 font-medium">PHP</span>, 
        ...
        <div className="flex justify-center gap-6 text-3xl text-gray-600">
          ...
          <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-700 transition duration-200">
            <FaLinkedin />
          </a>
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition duration-200">
            <FaTwitter />
          </a>
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-600 transition duration-200">
            <FaInstagram />
          </a>
        </div>
      </div>
